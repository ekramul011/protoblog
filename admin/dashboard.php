			...
			<div class="page-content">
					...
					<div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
						...
						<?php 
							...
							if ($totalPost = mysqli_query($db, $sql)) {
							    // Return the number of rows in totalPost
							    $countPost = mysqli_num_rows( $totalPost );

							   ?>

								<div class="col">
									<div class="card radius-10 bg-gradient-moonlit shadow">
									 <div class="card-body">
										<div class="d-flex align-items-center">
											<h5 class="mb-0 text-white">
												<?php 

													if ($countPost > 999 && $countPost <= 999999) {
													    $result = floor($countPost / 1000) . ' K';
													} elseif ($countPost > 999999) {
													    $result = floor($countPost / 1000000) . ' M';
													} else {
													    $result = $countPost;
													}
											...
											<div class="ms-auto">
		                                        <i class='bx bx-carousel fs-3 text-white'></i>
											</div>
										</div>
										<div>
											<br>
						...
						<?php 
							...
							if ($totalUser = mysqli_query($db, $sql)) {
							    // Return the number of rows in totalPost
							   ...
							   ?>
								...
								<div class="col">
									<div class="card radius-10 bg-gradient-ohhappiness shadow">
									 <div class="card-body">
										<div class="d-flex align-items-center">
											<h5 class="mb-0 text-white"><?php echo $countUser; ?></h5>
											<div class="ms-auto">
										...
										<div class="d-flex align-items-center text-white">
											<p class="mb-0">Admin Users (Active)</p>
											</span></p>
										</div>
									</div>
								  </div>
					 ...
					 <div class="row">
					  ...
					  <div class="card radius-10">
						<div class="card-body">
							<div class="d-flex align-items-center">
								<div>
									<h5 class="mb-0">Most Viewed Post</h5>
								</div>
								<div class="dropdown options ms-auto">
									<div class="dropdown-toggle dropdown-toggle-nocaret" data-bs-toggle="dropdown">
									  <i class='bx bx-dots-horizontal-rounded'></i>
							...
							<div class="table-responsive">
								<table class="table align-middle mb-0">
									...
									<?php 	
										...
										$sql = "SELECT * FROM post WHERE status = 1 ORDER BY view DESC LIMIT 6";
											...
											<tbody>
												<tr>
														...
														<div class="d-flex align-items-center">
															<div class="recent-product-img">
																<?php 	
																	...
																	if (!empty($image)) {
																		?>
																	<img src="assets/images/posts/<?php echo $image; ?>" alt="">
																	<?php 
																	}
													...
													<td>
														<?php 
															...
															while ($row = mysqli_fetch_assoc($paCate)) {
																...
																if ($category_id == $paCateId) {
																	echo $paCateName;
																}

																$sql2 = "SELECT * FROM category WHERE is_parent = '$paCateId' AND status = 1 ";
																$chCate = mysqli_query($db, $sql2);
																while ($row = mysqli_fetch_assoc($chCate)) {
																	$chCateId 	= $row['id'];
																	$chCateName = $row['name'];

																	if ($category_id == $chCateId) {
																	echo $chCateName;
																	}
													...
													<td>
														<?php 
															if ($status == 1) {
															echo '<div class="badge rounded-pill bg-light-info text-info w-100">Active</div>';
															} 
														?>
													...
													<td>
														<div class="d-flex order-actions">
															<a href="post.php?do=Edit&id=<?php echo $id; ?>" class="ms-4"><i class="bx bx-edit"></i></a>
														</div>
													</td>
												</tr>
											</tbody>
